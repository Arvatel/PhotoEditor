...
public class Filter {
    public static final int HIGHEST_COLOR_VALUE = 255;
    public static final int LOWEST_COLOR_VALUE = 0;

    static Bitmap applySketchFilter(Bitmap oldBitmap) {
    ...
    static Bitmap applyGreyFilter(Bitmap oldBitmap) {
        // copying to newBitmap for manipulation
        Bitmap newBitmap = oldBitmap.copy(Bitmap.Config.ARGB_8888, true);
    ...
    static Bitmap applySpeiaFilter(Bitmap oldBitmap) {
        // copying to newBitmap for manipulation
        Bitmap newBitmap = oldBitmap.copy(Bitmap.Config.ARGB_8888, true);
    ...
    static Bitmap applyCircularFilter(Bitmap oldBitmap) {
        Bitmap newBitmap = oldBitmap.copy(Bitmap.Config.ARGB_8888, true);
        int imageWidth = oldBitmap.getWidth();
        int imageHeight = oldBitmap.getHeight();

        int i, k = 0, l = 0;
        //davide the photo into four triangles
